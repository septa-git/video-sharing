...
const APP_NAME = "Anikaze";
const APP_DEFAULT_TITLE = "Anikaze - Watch Anime Online";
const APP_DESCRIPTION = "Explore a vast collection of anime on Anikaze, your go-to destination for streaming the latest and classic anime series. Immerse yourself in captivating storylines, vibrant animation, and diverse genres. Discover a world of entertainment at your fingertips with Anikaze, where every episode is an adventure.";

export const metadata = {
  metadataBase: new URL('https://anikaze.vercel.app/'),
